  ...
  function checkCollisions(){
    ...
    if ( sungod.xPosition + sungod.width >= pipes.getCurrentPipe().xPosition ){      
      if ( pipes.getCurrentPipe().valid == false && 
        (sungod.yPosition + 10 < pipes.getCurrentPipe().topCanvasYOffset ||
        sungod.yPosition + sungod.height - 10 > pipes.getCurrentPipe().yPosition) ){
          console.log('hit');
          hasHitPipe = true;
          countedScore = false;
          reset();
